...
; /  AFR VERSION 2.2 | CONFIG | Автоматически сгенерировано в AFR Editor v2.2
...
InitGBinds(i) {
    i["ForceStop"] := ['Insert', "[ForceStop] - Остановка отыгровки"]
    ...
    i["Npmp1_"] := ['', "[ПМП] Вывих сустава"]
    i["Npmp2_"] := ['', "[ПМП] Закрытый перелом"]
    i["Npmp3_"] := ['', "[ПМП] Открытый перелом"]
    i["Npmp15_"] := ['', "[ПМП] Пулевое ранение"]
    i["Npmp17_"] := ['', "[ПМП] Ножевое с ножом"]
    i["Npmp18_"] := ['', "[ПМП] Ножевое без ножа"]
    i["Npmp25_"] := ['', "[ПМП] Кровотечение: Артериальное"]
    i["Npmp39_"] := ['', "[ПМП] Сотрясение мозга: проверка"]
    i["Npmp40_"] := ['', "[ПМП] Сердечный приступ"]
    i["Npmp41_"] := ['', "[ПМП] Приступ (рубашка, ремень)"]
    i["Npmp44_"] := ['', "[ПМП] Эпилепсия"]
...
InitGBindsCfg(i) {
    ...
    i["Greetings_UseName"] := true
    i["Greetings_UseRole"] := true
